...
<!-- not sure what this is doing, but seems necessary -->
...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="CustomerAccountsServlet" method="post">
    <div class="container">
      ...
      <hr>
	      ...
	      <input type="text" placeholder="2109 Purple Street Rockhill CA 92024" name="address" required>
